...
def get_model_name(model_family):
    if model_family == 'gpt':
        ...
        return ['gemini-2.5-flash_thinking', 'gemini-2.5-pro_thinking'] 
...
def main():
    ...
    evaluator_group.add_argument('--eva_model_family', type=str, default='gpt', choices=['gemini', 'gpt', 'human', 'all'], required=True, help='Model family to evaluate.')
